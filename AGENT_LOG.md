...
- **2025-08-16**: Removed the fast polling loop and wired the random DMS button through the quiz generator so updates happen once per click.
- **2025-08-15**: Added clipboard buttons for DD and DMS pairs with status messaging.
